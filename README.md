...
**Naming Format:** mouseid_sliceid_roundnumber.excel <br /> **It is imperative that the mouse id, sliceid, and roundnumber are in this order, with "_" separating. You may add additional information afterwards separated by a "_".** <br />
**For example:** M123L_s1h1_1.excel (mouseid = M123L, sliceid = s1h1, round_number = 1) <br />
**Correct Example:** M123L_s1h1_1_PFA_jan_1_2000.excel, this is a correct way of naming the file <br />
**Incorrect Example:** M123L_jan_1_200_s1h1_1.excel, this is incorrect, the file should start with the mouseid, followed by the sliceid, followed by the roundnumber, then extra information may follow) <br />
